...
@Component({
  selector: "app-driver-installation-form",
  standalone: true,
  imports: [DxPopupModule, DxButtonModule, DxFormModule, DxDataGridModule],
  templateUrl: "./driver-installation-form.component.html",
})
export class DriverInstallationFormComponent {
  ...
  onValueChanged = (e: any) => {
    this.formTxnDocument().txn_end_date = e.value;
  };
