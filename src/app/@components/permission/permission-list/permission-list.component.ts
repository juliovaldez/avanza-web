...
import { PermissionFormComponent } from "@components/permission/permission-form/form-permission.component";
...
export class PermissionListComponent implements OnDestroy {
  ...
  async loadForm(id: number) {
    const instance: PermissionFormComponent = await this.lazyLoadService.load(
