...
@Component({
  selector: "app-grid-transaction-ont-out",
  standalone: true,
  imports: [
    DxPopupModule,
    DxButtonModule,
  ...
  templateUrl: "./grid-transaction-ont-out.component.html",
})
export class GridTransactionOntOutComponent implements OnInit {
    ...
    this.transactionStore
      ...
      ._load({
        ...
        group: [
          ...
          { "selector": "serial_number", "desc": false, "isExpanded": false },
        ],
        groupSummary: [
