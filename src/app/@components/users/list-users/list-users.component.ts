...
import { InventoryProfileComponent } from "../inventory-profile/inventory-profile.component";
...
export class ListUsersComponent implements OnInit, OnDestroy {
  ...
  async loadInventoryProfile(user: User) {
    const instance: InventoryProfileComponent = await this.lazyLoadService.load(
      lazyWidgets.inventory_profile,
      this.lazyContainer
    );
    console.log(instance);
    instance.loadForm(user.id);
  }
